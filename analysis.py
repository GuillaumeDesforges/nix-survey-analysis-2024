...
def process_question(
    ...
    answers_path = output_path / f"answers_{i_question}.json"
    with open(answers_path, "w") as f:
        json.dump(obj=answers.to_dicts(), fp=f)

    chart_plot_path = output_path / f"chart_plot_{i_question}.png"
    with open(chart_plot_path, "wb") as f:
        chart.save(fp=f, format="png", scale_factor=3)

    chart_json_path = output_path / f"chart_json_{i_question}.json"
